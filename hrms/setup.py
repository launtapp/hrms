...
migrate_records = [
	{
		...
		"modified": "2023-12-22 03:49:34.376911",
		"name": "Arrear",
		"only_tax_impact": 0,
		...
		"is_tax_applicable": 1,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:49:29.181477",
		...
		"description": "Advance Payment Repay From Salary",
		"do_not_include_in_total": 0,
		"docstatus": 0,
		"doctype": "Salary Component",
		"exempted_from_income_tax": 0,
		...
		"is_tax_applicable": 0,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:49:23.276401",
		"name": "Advance",
		"only_tax_impact": 0,
		"pay_against_benefit_claim": 0,
		"remove_if_zero_valued": 1,
		...
		"is_tax_applicable": 1,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:49:45.397182",
		"name": "Income Tax",
		"only_tax_impact": 0,
		"pay_against_benefit_claim": 0,
		"remove_if_zero_valued": 1,
		...
		"is_tax_applicable": 1,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:49:39.614473",
		"name": "Basic",
		"only_tax_impact": 0,
		"pay_against_benefit_claim": 0,
		"remove_if_zero_valued": 1,
		...
		"condition": "base <= 17500 && base >= 1650",
		"create_separate_payment_entry_against_benefit_claim": 0,
		"deduct_full_tax_on_selected_payroll_date": 0,
		"depends_on_payment_days": 1,
		...
		"doctype": "Salary Component",
		"exempted_from_income_tax": 0,
		"formula": "base * (5.00/100)",
		"is_flexible_benefit": 0,
		"is_income_tax_component": 0,
		"is_tax_applicable": 0,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:49:18.163500",
		"name": "Social Security Fund (1)",
		"only_tax_impact": 0,
		"pay_against_benefit_claim": 0,
		"remove_if_zero_valued": 1,
		"round_to_the_nearest_integer": 1,
		"salary_component": "Social Security Fund (1)",
		"salary_component_abbr": "S-SSF1",
		"statistical_component": 0,
		"type": "Deduction",
		"variable_based_on_taxable_salary": 0,
		"is_standard": 1
		...
		"amount": 875.0,
		"amount_based_on_formula": 0,
		"condition": "base > 17500",
		"create_separate_payment_entry_against_benefit_claim": 0,
		"deduct_full_tax_on_selected_payroll_date": 0,
		"depends_on_payment_days": 1,
		"description": "Base More Than ฿15,000",
		"do_not_include_in_total": 0,
		"docstatus": 0,
		"doctype": "Salary Component",
		"exempted_from_income_tax": 0,
		...
		"is_tax_applicable": 0,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:49:11.708908",
		"name": "Social Security Fund (2)",
		"only_tax_impact": 0,
		"pay_against_benefit_claim": 0,
		"remove_if_zero_valued": 1,
		"round_to_the_nearest_integer": 1,
		"salary_component": "Social Security Fund (2)",
		"salary_component_abbr": "S-SSF2",
		"statistical_component": 0,
		"type": "Deduction",
		"variable_based_on_taxable_salary": 0,
		"is_standard": 1
		...
		"is_tax_applicable": 0,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:49:06.125559",
		"name": "Others Deduction",
		"only_tax_impact": 0,
		"pay_against_benefit_claim": 0,
		"remove_if_zero_valued": 1,
		# "round_to_the_nearest_integer": 0,
		"salary_component": "Others Deduction",
		"salary_component_abbr": "S-OD",
		"statistical_component": 0,
		"type": "Deduction",
		"variable_based_on_taxable_salary": 0,
		"is_standard": 1
		...
		"is_tax_applicable": 0,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:49:00.614038",
		"name": "Damage Deduction",
		"only_tax_impact": 0,
		"pay_against_benefit_claim": 0,
		"remove_if_zero_valued": 1,
		# "round_to_the_nearest_integer": 0,
		"salary_component": "Damage Deduction",
		"salary_component_abbr": "S-DD",
		"statistical_component": 0,
		"type": "Deduction",
		"variable_based_on_taxable_salary": 0,
		"is_standard": 1
		...
		"is_tax_applicable": 0,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:48:53.819465",
		...
		"is_tax_applicable": 0,
		"max_benefit_amount": 0.0,
		"modified": "2023-12-22 03:48:46.835478",
		"name": "Late Deduction",
		"only_tax_impact": 0,
		"pay_against_benefit_claim": 0,
		"remove_if_zero_valued": 1,
...
def before_migrate():
	for data in migrate_records:
		is_exist = frappe.db.exists(data["doctype"], data["name"])
		if is_exist is not None:
			to_doc = dict(data)
			del to_doc["doctype"]
			del to_doc["name"]

			frappe.db.set_value(data["doctype"], data["name"], to_doc)
...
def make_fixtures():
	...
	records = records + migrate_records
